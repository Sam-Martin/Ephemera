...
module.exports = {
  ...
  generateS3PolicyString: function (params) {
    return '{\n    "expiration": "' + params.expiryDate + '",\n' + '   "conditions": [\n' + '       {"bucket": "' + params.bucketName + '"},' + '       {"key": "' + params.bucketKey + '"},' + '       {"acl": "' + params.s3ACL + '"},' + '       ["content-length-range",0, 512000],' + '       {"success_action_redirect": "' + params.successActionRedirect + '"},' + '       {"Content-Type": "' + params.contentType + '"}]\n}';
  },
  ...
  GenerateOutput: function (params, returnFunction) {
    ...
    var successActionRedirect = params.successActionRedirect;
    // + '&objectURL=' + objectURL
